...
class AppPrefsHelper constructor(context: Context, prefsName: String, private val gson: Gson) : PrefsHelper {
    ...
    companion object {
        ...
        const val KEY_LOGIN_MODE= "KEY_LOGIN_MODE"
    }
    ...
    override fun getLoginMode(): Boolean {
        return sharedPreferences.getBoolean(KEY_LOGIN_MODE, false)
    }

    override fun saveLoginMode(mode: Boolean) {
       sharedPreferences.edit().putBoolean(KEY_LOGIN_MODE,mode).apply()
    }
